...
<html lang="es">
    ...
    <body>
        ...
        <article class="segundot">
            <h2>Desarrollo Web Entorno Cliente - TEMA 1</h2>
        </article>
            ...
            <section class="primerasfilas">
                <table class="tabla">
                    <tr class="bordetitulo">
                        <td>
                            <figure>
                                <a href="../doc/ResumenUD1.pdf" target="_blank"><figcaption class="titulofoto">Resumen del contenido del TEMA 1</figcaption></a>
                            </figure>
                        </td>
                    </tr>
                </table>
